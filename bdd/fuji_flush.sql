...
# main du joueur 3 :
insert into Main(Jeu_id, Jeu_EstJoue_Partie_id, Jeu_EstJoue_Joueur_id, main) values(1,1,3,'3;5;1;6;10;11;');

# premier jeu, le joueur a posé une carte de valeur 6 :
update Jeu set carteJoue = 6 where id = 1 and EstJoue_Partie_id = 1;

# jeu n°2 le joueur suivant pose une carte de valeur 8 :
insert into jeu(id, EstJoue_Partie_id, EstJoue_Joueur_id, carteJoue) values(2,1,1,8);

# au jeu n°2 les mains des deux premiers joueurs ont changé : joueur 2 perds sa carte 8
insert into Main(Jeu_id, Jeu_EstJoue_Partie_id, Jeu_EstJoue_Joueur_id, main) values(2,1,2,'2;2;9;10;7;');
# joueur 1 perds sa carte 6 et en prends une dans la pioche :
insert into Main(Jeu_id, Jeu_EstJoue_Partie_id, Jeu_EstJoue_Joueur_id, main) values(2,1,1,'3;2;2;5;4;13;');
