...
insert into Jeu(id, EstJoue_Partie_id, EstJoue_Joueur_id) values(1,2,4);
...
values(1,2,4,'3;10;2;5;6;13;',1,2,4);
# main du joueur 2 :
insert into Main(id, EstJoue_Partie_id, EstJoue_Joueur_id, main, Jeu_id, Jeu_EstJoue_Partie_id, Jeu_EstJoue_Joueur_id) 
values(1,2,2,'8;2;6;9;10;7;',1,2,4);
# main du joueur 3 :
insert into Main(id, EstJoue_Partie_id, EstJoue_Joueur_id, main, Jeu_id, Jeu_EstJoue_Partie_id, Jeu_EstJoue_Joueur_id) 
values(1,2,3,'3;6;1;6;10;11;',1,2,4);

# premier jeu, le joueur a posé une carte de valeur 10 :
update Jeu set carteJoue = 10 where id = 1 and EstJoue_Partie_id = 2 and EstJoue_Joueur_id = 4;
...
insert into Jeu(id, EstJoue_Partie_id, EstJoue_Joueur_id, carteJoue) values(2,2,2,6);
insert into Main(id, EstJoue_Partie_id, EstJoue_Joueur_id, main, Jeu_id, Jeu_EstJoue_Partie_id, Jeu_EstJoue_Joueur_id) 
values(2,2,2,'8;2;9;10;7;',2,2,2);

# jeu n°3 le joueur suivant pose une carte de valeur 6 :
insert into Jeu(id, EstJoue_Partie_id, EstJoue_Joueur_id, carteJoue) values(3,2,3,6);
insert into Main(id, EstJoue_Partie_id, EstJoue_Joueur_id, main, Jeu_id, Jeu_EstJoue_Partie_id, Jeu_EstJoue_Joueur_id) 
values(2,2,3,'3;6;1;10;11;',3,2,3);

# au jeu n°3 seul la main du premier joueur a changé : joueur 1 perds sa carte 10 et en prend une dans la pioche
insert into Main(id, EstJoue_Partie_id, EstJoue_Joueur_id, main, Jeu_id, Jeu_EstJoue_Partie_id, Jeu_EstJoue_Joueur_id) 
values(2,2,4,'3;4;2;5;6;13;', 3,2,3);
...
insert into Jeu(id, EstJoue_Partie_id, EstJoue_Joueur_id, carteJoue) values(4,2,3,1);
insert into Main(id, EstJoue_Partie_id, EstJoue_Joueur_id, main, Jeu_id, Jeu_EstJoue_Partie_id, Jeu_EstJoue_Joueur_id) 
values(3,2,3,'3;6;10;11;',4,2,3);
